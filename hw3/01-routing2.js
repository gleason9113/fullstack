...
const server = http.createServer((req, res) => {
  ...
  switch (req.url) {
    ...
    case '/redirected':
      ...
      break;
    case '/cache':
      res.writeHead(200, { 'Content-Type': 'text/html' }, { 'Cache-Control': 'max-age: 86_400'});
      res.write(`This resource was cached.`);
      res.end();
      break;
    case '/cookie':
      res.writeHead(200, { 'Content-Type': 'text/html' }, { 'Set-Cookie': 'hello=world; Max-Age=600_000; Same-Site=None'});
      res.cookie
